...
async function rebuild () {
  ...
  const docs = await getDocs(api, 1, [])
...
async function getDocs (api, page, docs) {
  ...
  return api.query([
    ...
    if (response.next_page !== null) {
      return getDocs(api, page + 1, docs.concat(response.results))
    }
