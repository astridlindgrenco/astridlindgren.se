...
module.exports = function document (view, ctx) {
  return `
    ...
    <head>
      ...
      <meta http-equiv="Content-Security-Policy" content="img-src 'self' https://images.prismic.io; script-src 'self' 'unsafe-inline' https://static.cdn.prismic.io https://cdnjs.cloudflare.com https://addsearch.com https://cdn.polyfill.io; style-src 'self' 'unsafe-inline';">
      ${meta(ctx.state)}
      ${favicon()}
      <meta charset="utf-8">
