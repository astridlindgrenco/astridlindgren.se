...
function meta (state) {
  ...
  return `
      ...
      <meta name="twitter:title" content="${state.meta.seo_title || ''}">
      <meta property="og:title" content="${state.meta.seo_title || ''}"/>
      <meta name="twitter:description" content="${state.meta.seo_description || ''}">
      <meta property="og:description" content="${state.meta.seo_description || ''}"/>
      <meta name="twitter:image" content="${state.meta.seo_image || ''}"/>
      <meta property="og:image" content="${state.meta.seo_image || ''}"/>
      ${(() => {
