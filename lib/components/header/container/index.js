...
module.exports = function headerContainer (appState, element) {
  ...
  element.parentNode.replaceChild(header(appState.navDocument, headerState, appState.locales, appState.locale), element)

  function update () {
    header(appState.navDocument, headerState, appState.locales, appState.locale)
  }
}
