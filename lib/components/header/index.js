...
var header = module.exports = component(function header (ctx, navDocument, { nav, search, lang }) {
  ...
  return html`
    <header class="${classes}" data-container="header">
      ...
      <nav class="Header-nav u-sizeFill" aria-hidden="${!Boolean(nav.isToggled)}">
        ...
        <aside class="Header-aside u-sizeFit">
          ...
          <div class="Header-actions">
            <div class="Header-action Header-action--lang">
              <button class="Header-actionTrigger" onclick=${lang.toggle}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <path d="M0 0h24v24H0z" fill="none"/>
              ...
              <div class="Header-actionPanel" aria-hidden="${!Boolean(lang.isToggled)}">
                <a href="/">SV</a>
                <a href="/en/">EN</a>
                <a href="/de/">DE</a>
              </div>
            ...
            <div class="Header-action Header-action--search">
              <button class="Header-actionTrigger" onclick=${search.toggle}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              ...
              <div class="Header-actionPanel" aria-hidden="${!Boolean(search.isToggled)}">
