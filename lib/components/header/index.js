...
var header = module.exports = component(function header (ctx, navDocument, { nav, search, lang }) {
  ...
  const homeTitle = 'Till hemsidan/Zur Startseite/To start page/На стартовую страницу' // FIXME __('Home')
  return html`
    <header class="${classes}" data-container="header">
      <div class="Header-logo u-sizeFit">
        ${logo({ alt: 'Astrid Lindgren Company', isFill: true, title: homeTitle })}
      </div>
