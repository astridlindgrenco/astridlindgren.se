...
var header = module.exports = component(function header (ctx, navDocument, { nav, search, lang }, locales, locale) {
          ...
          <div class="Header-actions">
            <div class="Header-action Header-action--lang">
              <button class="Header-actionTrigger" onclick=${lang.toggle} title="${locales.language}">
                ...
                <span class="Header-actionLabel">${locales.language}</span>
              </button>
            ...
            <div class="Header-action Header-action--search">
              <button class="Header-actionTrigger" onclick=${search.toggle} title="${locales.search}">
                ...
                <span class="Header-actionLabel">${locales.search}</span>
              </button>
