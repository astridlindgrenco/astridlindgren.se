...
var header = module.exports = component(function header (ctx, navDocument, hasOpenNav, onToggleNav) {
  var classes = className('Header', {
    'Header--withOpenNav': hasOpenNav
  })
  var primaryNavItems = [
    { label: 'Astrid Lindgren', href: '#' },
    { label: 'Verken', href: '#', isActive: true },
    { label: 'Karaktärerna', href: '#' },
    { label: 'Företaget', href: '#' }
  ]
  var secondaryNavItems = [
    { label: 'Kontakt', href: '#' },
    { label: 'Besöksmålen', href: '#', isSecondary: true }
  ]
