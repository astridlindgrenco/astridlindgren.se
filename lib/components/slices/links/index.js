...
function links (slice, state, container) {
  ...
  if (data.intro_text.length || data.intro_title.length) header.push(html`<div class="Display-title">${asElement(data.intro_title ? data.intro_title : '')}</div><div class="Text">${asElement(data.intro_text ? data.intro_text : '')}</div>`)
