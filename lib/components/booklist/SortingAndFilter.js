...
module.exports = function SortingAndFilter (defaultView, defaultSortBy) {
  console.log(1, defaultView, defaultSortBy)
  return html`
  <form>
  ...
  <script>
    ...
    if (sortBy === 'book_title' || (!sortBy && '${defaultSortBy}' ==='book_title')) {
    ...
    if (viewBy === 'grid' || (!viewBy && '${defaultView}' ==='grid')) {
