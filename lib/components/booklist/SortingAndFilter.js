...
module.exports = function SortingAndFilter () {
  ...
  <form>
    <div class="Booklist-sortAndFilter">
      ...
      <div>
        <input id="viewByList" type="radio" name="view" value="list">
        <label for="viewByList">Lista</label>
      </div>
      <div>
        <input id="viewByGrid" type="radio" name="view" value="list">
  ...
  <script>
    ...
    if (viewBy === 'grid') {
      document.getElementById('viewByGrid').selected = true;
    } else {
      document.getElementById('viewByList').selected = true;
    }
  </script>
`
}
