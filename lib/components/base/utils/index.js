...
const SIZES = [
  ['fw-small', 0, [480, 960, 1440], [80, 40, 30]],
  ['hw-small', 0, [220, 440, 700], [80, 40, 30]],
  ['tw-small', 0, [140, 280, 460], [80, 40, 30]],
  ['qw-small', 0, [100, 200, 340], [80, 40, 30]],
  ['pw-small', 0, [76, 152, 268], [80, 40, 30]],
  ['fw-medium', 480, [1024, 2048, 3072], [80, 40, 30]],
  ['hw-medium', 480, [492, 984, 1516], [80, 40, 30]],
  ['tw-medium', 480, [321, 643, 1004], [80, 40, 30]],
  ['qw-medium', 480, [236, 472, 748], [80, 40, 30]],
  ['pw-medium', 480, [185, 370, 594], [80, 40, 30]],
  ['fw-large', 1024, [1250, 2500, 3750], [80, 40, 30]],
  ['hw-large', 1024, [605, 1210, 1855], [80, 40, 30]],
  ['tw-large', 1024, [397, 793, 1230], [80, 40, 30]],
  ['qw-large', 1024, [293, 585, 918], [80, 40, 30]],
  ['pw-large', 1024, [230, 460, 730], [80, 40, 30]],
  ['fw-xlarge', 1250, [1440, 2880, 4320], [80, 40, 30]],
  ['hw-xlarge', 1250, [700, 1040, 2140], [80, 40, 30]],
  ['qw-xlarge', 1250, [460, 920, 1420], [80, 40, 30]],
  ['qw-xlarge', 1250, [340, 680, 1060], [80, 40, 30]],
  ['pw-xlarge', 1250, [268, 536, 844], [80, 40, 30]]
]
...
exports.dividerImage = function dividerImage (url) {
  ...
  return {
    srcset: `${CDN_URL}tr:h-80,w-80,c-at_max,dpr-3,q=30/${uri} 240w,
             ${CDN_URL}tr:h-80,w-80,c-at_max,dpr-2,q=40/${uri} 160w,
             ${CDN_URL}tr:h-80,w-80,c-at_max,dpr-1/${uri} 80w,
             ${CDN_URL}tr:h-60,w-60,c-at_max,dpr-3,q=30/${uri} 180w,
             ${CDN_URL}tr:h-60,w-60,c-at_max,dpr-2,q=40/${uri} 120w,
             ${CDN_URL}tr:h-60,w-60,c-at_max,dpr-1/${uri} 60w`,
...
exports.characterImage = function characterImage (url) {
  const uri = url.split(SOURCE_URL)[1]
  return {
    srcset: `${CDN_URL}tr:h-150,w-150,c-at_max,dpr-3,q=30/${uri} 3x,
             ${CDN_URL}tr:h-150,w-150,c-at_max,dpr-2,q=40/${uri} 2x,
             ${CDN_URL}tr:h-150,w-150,c-at_max,dpr-1/${uri} 1x`,
    src: `${CDN_URL}tr:h-150,w-150,c-at_max,dpr-1/${uri} 1x,`
  }
}
