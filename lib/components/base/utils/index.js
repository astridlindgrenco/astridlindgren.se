...
exports.characterImage = function characterImage (url) {
  const uri = url.split(SOURCE_URL)[1]
  return {
    srcset: `${CDN_URL}tr:h-300,w-300,c-at_max,dpr-3/${uri} 3x,
             ${CDN_URL}tr:h-300,w-300,c-at_max,dpr-2/${uri} 2x,
             ${CDN_URL}tr:h-300,w-300,c-at_max,dpr-1/${uri} 1x`,
    src: `${CDN_URL}tr:h-300,w-300,c-at_max,dpr-1/${uri}`
  }
}
