...
exports.dividerImage = function dividerImage (url) {
  ...
  return {
    srcset: `${CDN_URL}tr:h-80,w-80,c-at_max,dpr-3.0/${uri} 240w,
             ${CDN_URL}tr:h-80,w-80,c-at_max,dpr-2.0/${uri} 160w,
             ${CDN_URL}tr:h-80,w-80,c-at_max,dpr-1.0/${uri} 80w,
             ${CDN_URL}tr:h-60,w-60,c-at_max,dpr-3.0/${uri} 180w,
             ${CDN_URL}tr:h-60,w-60,c-at_max,dpr-2.0/${uri} 120w,
...
exports.characterImage = function characterImage (url) {
  const uri = url.split(SOURCE_URL)[1]
  return {
    srcset: `${CDN_URL}tr:h-150,w-150,c-at_max,dpr-3/${uri} 3x,
             ${CDN_URL}tr:h-150,w-150,c-at_max,dpr-2/${uri} 2x,
             ${CDN_URL}tr:h-150,w-150,c-at_max,dpr-1/${uri} 1x`,
    src: `${CDN_URL}tr:h-150,w-150,c-at_max,dpr-1/${uri}`
  }
}
...
exports.getApi = async function getApi (req) {
  return Prismic.api(
