...
exports.dividerImage = function dividerImage (url) {
  ...
  return {
    srcset: `${url}&h=80&w=80&dpr=3 240w,
              ${url}&h=80&w=80&dpr=2 160w,
              ${url}&h=80&w=80&dpr=1 80w,
              ${url}&h=60&w=60&dpr=3 180w,
              ${url}&h=60&w=60&dpr=2 120w,
              ${url}&h=60&w=60&dpr=1 60w`,
    sizes: '(min-width: 480px) 80px, 60px',
    src: `${url}&h=80&w=80&dpr=1`
  }
}
...
exports.characterImage = function characterImage (url) {
  ...
  return {
    srcset: `${url}&h=300&w=300&dpr=3 3x,
             ${url}&h=300&w=300&dpr=2 2x,
             ${url}&h=300&w=300&dpr=1 1x`,
    src: `${url}&h=300&w=300&dpr=1`
  }
}
