...
exports.getCustomFontStylesheet = function getCustomFontClass (fontName) {
  ...
  const font = getFont(fontName)
  return font ? html`<link rel="stylesheet" href="/fonts/custom-font-${font.stylesheet.toLowerCase()}.css">` : ''
}

function getFont (fontName) {
  return fonts.find(font => font.id.toLowerCase() === fontName.toLowerCase())
}
