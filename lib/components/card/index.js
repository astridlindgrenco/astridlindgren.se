...
function card ({
  ...
  return html`
    <div class="${classes}">
      ...
      <div class="Card-content${layout === 'horisontal' ? ' u-paddedBox' : ''} u-colorFor${bgClassName}">
      ${category ? html`<div class="Card-category"> ${Category(category, (hasBody && layout === 'horisontal' ? (divider !== 'default' ? divider : false) : divider))} </div>` : ''}
