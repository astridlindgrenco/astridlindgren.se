  ...
  return html`
    <form class="Filter-sorting" action="${formAction || ''}">
      <div class="Grid Grid--withGutter">
        ${left
          ? html`
            <div class="Filter-sortLeft u-flex u-flexCol u-lg-flexRow u-lg-flexJustifyStart u-lg-size1of2">
        ...
        ${right
          ? html`
            <div class="Filter-sortRight u-flex u-flexCol u-lg-flexRow u-lg-flexJustifyEnd u-lg-size1of2">
              <div class="Filter-sortHeader u-sm-sizeFill u-md-size1of6 u-lg-sizeFit u-flex u-flexAlignItemsCenter">
