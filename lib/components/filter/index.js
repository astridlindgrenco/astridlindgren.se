...
function Filter ({
  ...
  return html`
    <div class="${classes}" data-container="filter" data-filter-active="${hasActiveFilter}">
      ...
      ${sortingOptions ? sortingAndLayout(sortingOptions, formAction) : ''}
    </div>
  `
}
 ...
 * @param  {String}  formAction URL for form submission
 * @return {Object}             Nanohtml view
 */
function filterSection (filter, formAction) {
 ...
 * @return {Object}             Nanohtml view
 */
function sortingAndLayout (options, formAction) {
