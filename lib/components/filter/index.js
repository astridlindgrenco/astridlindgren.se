  ...
  return html`
    <div class="Filter-sorting">
      <div class="Grid Grid--withGutter">
        ${left
          ? html`
            <div class="Filter-sortLeft u-flex u-flexJustifyStart u-size1of2">
              <div class="Filter-sortHeader u-sizeFit u-flex u-flexAlignItemsCenter">
                <p class="Text-label">${raw(left.header)}</p>
              </div>
              <form class="Filter-form u-sizeFit" action="${formAction || ''}">
                ${left.body}
              </form>
            </div>
          `
        ...
        ${right
          ? html`
            <div class="Filter-sortRight u-flex u-flexJustifyEnd u-size1of2">
              <div class="Filter-sortHeader u-sizeFit u-flex u-flexAlignItemsCenter">
              ...
              return html`
                <div class="Filter-toggle">
                  ${choices.map(function createChoice (choice) {
                    return html`
                      <input class="Filter-toggleInput" id="${choice.id}" type="radio" name="${choice.name}" value="${choice.value}" onchange="this.form.submit()">
